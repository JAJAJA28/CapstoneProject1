...
const { loggedInUser } = useAuth();  // makukuha mo na yung email dito
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            const serverUrl = "http://10.203.3.62/system/first_communion_submit.php";
                    ...
                    <ScrollView contentContainerStyle={[styles.container, { paddingHorizontal: responsiveStyles.containerPadding }]}>
                        ...
                        <View style={styles.formContainer}>
                            ...
                            <TextInput
                                ...
                                placeholder="Petsa ng Komunyon (MM/DD/YYYY)"
                                placeholderTextColor="#999"
                                keyboardType="numbers-and-punctuation"
                                onChangeText={(text) => handleInputChange("communionDate", text)}
                            />
                            <TextInput
                                style={[styles.input, {
                                    fontSize: responsiveStyles.inputFontSize,
                            ...
                            <TextInput
                                ...
                                placeholder="Petsa ng Binyag (MM/DD/YYYY)"
                                placeholderTextColor="#999"
                                keyboardType="numbers-and-punctuation"
                                onChangeText={(text) => handleInputChange("baptismDate", text)}
                            />
                            <TextInput
                                style={[styles.input, {
                                    fontSize: responsiveStyles.inputFontSize,
